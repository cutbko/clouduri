...
using CloudUri.Web.Extensions;

namespace CloudUri.Web.Infrastructure
{
    public class AccountMembershipProvider : MembershipProvider
    {
        ...
        public AccountMembershipProvider(IAccountService accountService)
        {
        ...
        {
            User user = _accountService.CreateUser(username, password, email);
            if (user != null)
            {
        ...
        {
            return _accountService.ChangePassword(username, oldPassword, newPassword);
        }
        ...
        {
            return _accountService.GetUserNameByEmail(email);
        }
        ...
        {
            return _accountService.DeleteUser(username, deleteAllRelatedData);
        }
        ...
        {
            return _accountService.GetAllUsers(pageIndex, pageSize, out totalRecords).ToMembershipUserCollection();
        }
        ...
        {
            return _accountService.FindUsersByName(usernameToMatch, pageIndex, pageSize, out totalRecords).ToMembershipUserCollection();
        }
