...
namespace CloudUri.Web.Infrastructure
{
    public class AccountRoleProvider : RoleProvider
    {
        ...
        public AccountRoleProvider(IAccountService accountService)
        {
        ...
        {
            return _accountService.IsUserInRole(username, roleName);
        }
        ...
        {
            return _accountService.DeleteRole(roleName, throwOnPopulatedRole);
        }
        ...
        {
            return _accountService.RoleExists(roleName);
        }
        ...
        {
            _accountService.AddUsersToRoles(usernames, roleNames);
        }
        ...
        {
            _accountService.RemoveUsersFromRoles(usernames, roleNames);
        }
        ...
        {
            return _accountService.GetUsersInRole(roleName);
        }
        ...
        {
            return _accountService.FindUsersInRole(roleName, usernameToMatch);
        }
